package com.vysh.blackjack.service;

import com.vysh.blackjack.exception.BlackjackErrorCode;
import com.vysh.blackjack.exception.BlackjackException;
import com.vysh.blackjack.model.wrapper.GameInfoWrapper;
import com.vysh.blackjack.model.wrapper.PlayerHandWrapper;
import com.vysh.blackjack.model.wrapper.PlayerListWrapper;
import com.vysh.blackjack.model.*;
...
public class BlackjackService {
    ...
    public GameInfoWrapper processAction(String playerId, int handNum, Action action) throws BlackjackException {
        ...
        // If all players are done acting, then let the dealer do his thing, evaluate hands, then pay out accordingly
        if (game.isActionDone()) {
            performDealerAction();
            evaluateHands();
